...
definitions = [
    ...
    ('model',            (str,   'dilated-densenet2', "Model: unet, dilated-unet, dilated-densenet")),
    ('features',         (int,   32,     "Number of features maps after first convolutional layer.")),
    ('depth',            (int,   3,      "Number of downsampled convolutional blocks.")),
    ('temperature',      (float, 1.0,    "Temperature of final softmax layer in weight.")),
    ...
    ('batch-size',       (int,   3,     "Mini-batch size for training.")),
    ...
    # ('beta1',            (float, 0.9,    "Adam optimizer params")),
    # ('beta2',            (float, 0.999,  "Adam optimizer params")),
    ('momentum',         (float, None,   "Momentum for SGD optimizer.")),
    ('decay',            (float, 0.0,   "Learning rate decay (not applicable for nadam).")),
    ...
    # files
    ('datadir',          (str,   'E:\workspace\dataset\RVSC\TrainingSet',    "Directory containing patientXX/ directories.")),
    ('outdir',           (str,   '.',    "Directory to write output data.")),
    ('outfile',          (str,   'dialted-densenet2.hdf5', "File to write final weight weights.")),
    ('load-weights',     (str,   'dialted-densenet2.hdf5', "Load weight weights from specified file to initialize training.")),
    ('checkpoint',       {'default': False, 'action': 'store_true',
                          'help': "Write weight weights after each epoch if validation accuracy improves."}),
